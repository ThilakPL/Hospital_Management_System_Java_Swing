...
public class LoginDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 350, 120, 40));
        ...
        jPanel1.add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 350, 120, 40));
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(n1.equals(username1) && n2.equals(psd)){
                   ...
                   this.dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
                   InDoctorIndex Id1 = new InDoctorIndex(username);
                   //InDoctor1 Id1 = new InDoctor1();
                   Id1.setVisible(true);
                   
                   //new InDoctor21(username).setVisible(true);
